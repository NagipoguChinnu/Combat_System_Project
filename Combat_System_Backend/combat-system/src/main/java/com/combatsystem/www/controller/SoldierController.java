...
public class SoldierController {
    ...
    @GetMapping("/pending")
    public ResponseEntity<List<SoldierDto>> getPendingOperators() {
    ...
    @GetMapping("/denied")
    public ResponseEntity<List<SoldierDto>> getDeniedOperators() {
    ...
    @GetMapping("/get")
    public ResponseEntity<SoldierDto> getSoldierByEmail(@RequestParam String email) {
        SoldierDto soldier = soldierService.getSoldierByEmail(email);
        if (soldier != null) {
    ...
    @PutMapping("/update")
    public SoldierDto updateSoldier(@RequestBody SoldierDto soldierDto) {
        return soldierService.updateSoldier(soldierDto);
    }
}
