...
public class SoldierService {
    ...
    public SoldierDto updateSoldier(SoldierDto dto) {
        Optional<Soldier> soldierOpt = soldierRepository.findFirstByEmail(dto.getEmail());
        ...
        soldier.setUserName(dto.getUserName());
        soldier.setDeviceType(dto.getDeviceType());
        soldier.setLatitude(dto.getLatitude());
        soldier.setLongitude(dto.getLongitude());
        soldier.setPassword(dto.getPassword());

        Soldier updated = soldierRepository.save(soldier);
